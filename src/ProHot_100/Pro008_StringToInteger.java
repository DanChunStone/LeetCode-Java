 ...
 * @date 2021/4/1 11:30
 */
public class Pro008_StringToInteger {
...
//        System.out.println(new Solution().myAtoi("words and 987"));
    ...
    static class Solution {
        static long MAX = 2147483647L;
        static long MIN = -2147483648L;
        ...
        public int myAtoi(String s) {
            ...
            while (index < s.length()) {
                ...
                if (c >= '0' && c <= '9') {
                    ...
                    if (prefix * result >= MAX || prefix * result <= MIN) {
                        return (int) Math.min(Math.max(prefix * result, MIN), MAX);
                    }
                } else {
                    return (int) Math.min(Math.max(prefix * result, MIN), MAX);
                }
